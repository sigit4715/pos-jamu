...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/kasir', [SaleController::class, 'create'])->name('sales.create');
    Route::post('/kasir', [SaleController::class, 'store'])->name('sales.store');
    ...
    Route::middleware('role:admin,kasir')->group(function () {
        ...
        Route::get('/kartu-stok', [StockController::class, 'index'])->name('stock-card.index');
        Route::get('/batch-kedaluwarsa', [BatchController::class, 'index'])->name('batches.index');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('/audit-aktivitas', [AuditController::class, 'index'])->name('audit.index');
