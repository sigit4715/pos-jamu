...
{
    protected $fillable = ['stock_transfer_id', 'source_product_id', 'destination_product_id', 'product_packaging_id', 'product_name', 'unit_name', 'conversion_quantity', 'quantity', 'base_quantity', 'received_quantity'];
