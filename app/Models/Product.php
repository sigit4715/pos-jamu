...
{
    protected $fillable = ['store_id', 'category_id', 'unit_id', 'brand_id', 'supplier_id', 'code', 'barcode', 'name', 'description', 'price', 'buy_price', 'stock', 'minimum_stock', 'unit', 'is_active'];
    ...
    public function packagings() { return $this->hasMany(ProductPackaging::class); }
}
