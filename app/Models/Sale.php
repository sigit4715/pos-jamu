...
{
    protected $fillable = ['store_id', 'invoice_number', 'idempotency_key', 'cashier_id', 'shift_id', 'customer_id', 'customer_name', 'subtotal', 'discount', 'total', 'payment_method', 'paid_amount', 'change_amount', 'notes'];
